...
const (
	...
	// CRUNCHY_BRIDGE
	CRUNCHY_BRIDGE_CATALOG_IMG = "quay.io/olavtar/crunchy-bridge-operator-catalog:v0.0.5-dev"
	CRUNCHY_BRIDGE_CSV         = "crunchy-bridge-operator.v0.0.5-dev"
	...
	// MONGODB_ATLAS
	MONGODB_ATLAS_CATALOG_IMG = "quay.io/olavtar/mongodb-atlas-kubernetes-dbaas-catalog:0.3.0"
